...
namespace ElectronicJournalEntities
{
    public class Student
    {
        ...
        public Student(Guid? id, string firstName, string lastName, String school, String class_, string phone, string eMail, string password, DateTime? registrationDate)
        {
            ID = id;
            FirstName = firstName;
            LastName = lastName;
